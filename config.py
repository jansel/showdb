...
rss_feed_urls = [
  ...
  'http://kickass.to/usearch/category:tv%20lang_id:2%20verified:1/?rss=1',
]
rss_interval = 3600
rss_timeout = 60

#configuration for ircshowfeed
irc_servers = ['irc.shoutcast.com', 'irc.umich.edu', 'irc.paraphysics.net',
               'efnet.multiplay.co.uk', 'irc.igs.ca', 'irc.blessed.net',
               'irc.prison.net']
...
irc_names = ['asheeghouj', 'aethohgain', 'ooweishedu', 'cheeshusho',
             'ahngengoit', 'oocaisheok', 'ohkeethaem', 'jochaceaju',
             'kucuocooju', 'shaetheika', 'owahghasoa', 'oopaxeephi',
             'easaepaipe', 'ahzaixueko', 'iefefoongo', 'caephophau',
             'aesheeghaj', 'xiengeolep', 'riedaepoop', 'yaiquahdee',
             'uuvahsohzo', 'aitheeshof', 'zedeithohd', 'aiseemaesh',
             'ooxohchaid', 'aiheixoshe', 'ohyiepahmi', 'ooghaequae',
             'ohoalohyee', 'aikeingaik', 'uvuaciepho', 'ifeishaihu',
             'oogoobahla', 'piemowieph', 'iehiewooth', 'ohseimothe',
             'shaewuajao', 'aophahphie', 'veedungeiv', 'heiwahlaed',
             'daigoringo', 'fuceingici', 'iuphaepoom', 'oovuufohli',
             'shamodahvi', 'ohthaeloul', 'teiphaelue', 'ceixahvoht',
             'equiephouc', 'ieniasairo', 'yiesoefije', 'quaicohphi',
             'mailaengoh', 'aiwaeghoog', 'dusanieril', 'quieduayei',
             'eeweezaesh', 'reghuchied', 'dauceizeeh', 'ahlookaice',
             'pohcoxukev', 'thahghohqu', 'teyajahphi', 'timeingose']
